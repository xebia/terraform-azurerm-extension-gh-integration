...
If you encounter DNS lookup errors for storage accounts (like `pdkterraformstateprod.blob.core.windows.net` not found), the visible variable values in logs help identify:
...
Storage Account: pdkterraformstateprod
Container: tfstate
Key: pdk-dev-integration.tfstate
...
### DNS Lookup Failures
If you see errors like "no such host pdkterraformstateprod.blob.core.windows.net":
