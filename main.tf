...
locals {
  ...
  spoke_outputs_tfvars_content = templatestring(data.local_file.spoke_outputs_tfvars_template.content, {
    ...
    log_analytics_workspace_id   = coalesce(try(var.spoke_outputs.log_analytics_workspace_id, ""), var.log_analytics_workspace_id, "")
    application_insights_id      = coalesce(try(var.spoke_outputs.application_insights_id, ""), var.application_insights_id, "")
  })
